    ...
    <section className='bg-section dark:bg-darklight' id='services'>
      <div className='container mx-auto max-w-6xl px-4'>
        ...
        <h2
          ...
          data-aos-delay='200'
          data-aos-duration='1000'>
          End-to-end job placement support tailored for your success
        </h2>
        <div className='grid md:grid-cols-12 sm:grid-cols-8 grid-cols-1 gap-7'>
          {Servicebox.map((item, index) => (
            <div
              ...
              {index === 0 && (
                <Icon icon='mdi:file-document-outline' width='40' height='40' className='text-primary' />
              )}
              {index === 1 && (
                <Icon icon='mdi:briefcase-outline' width='40' height='40' className='text-primary' />
              )}
              {index === 2 && (
                <Icon icon='mdi:handshake' width='40' height='40' className='text-primary' />
              )}
